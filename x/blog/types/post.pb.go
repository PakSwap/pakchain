...
func (m *Post) GetResponse() string {
	if m != nil {
		return m.Response
	}
	return ""
...
func init() {
	proto.RegisterType((*Post)(nil), "ahmetson.chain.blog.Post")
}
...
var fileDescriptor_1da4a141e1c534d3 = []byte{
	...
	0xd7, 0x2f, 0xc8, 0x2f, 0x2e, 0xd1, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0x4e, 0xcc, 0xc8,
	0x4d, 0x2d, 0x29, 0xce, 0xcf, 0xd3, 0x4b, 0xce, 0x48, 0xcc, 0xcc, 0xd3, 0x03, 0xc9, 0x2b, 0x25,
	0x71, 0xb1, 0x04, 0xe4, 0x17, 0x97, 0x08, 0x49, 0x70, 0xb1, 0x27, 0x17, 0xa5, 0x26, 0x96, 0xe4,
	0x17, 0x49, 0x30, 0x2a, 0x30, 0x6a, 0x70, 0x06, 0xc1, 0xb8, 0x42, 0x7c, 0x5c, 0x4c, 0x99, 0x29,
	0x12, 0x4c, 0x0a, 0x8c, 0x1a, 0x2c, 0x41, 0x4c, 0x99, 0x29, 0x42, 0x22, 0x5c, 0xac, 0x25, 0x99,
	0x25, 0x39, 0xa9, 0x12, 0xcc, 0x60, 0x75, 0x10, 0x8e, 0x90, 0x14, 0x17, 0x47, 0x51, 0x6a, 0x71,
	0x41, 0x7e, 0x5e, 0x71, 0xaa, 0x04, 0x0b, 0x58, 0x02, 0xce, 0x77, 0x72, 0x38, 0xf1, 0x48, 0x8e,
	...
	0xfc, 0x5c, 0x7d, 0x98, 0xeb, 0xf4, 0xc1, 0xae, 0xd3, 0xaf, 0xd0, 0x07, 0xbb, 0xbf, 0xa4, 0xb2,
	0x20, 0xb5, 0x38, 0x89, 0x0d, 0xec, 0x03, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x41, 0x5b,
	0x34, 0x5b, 0xd4, 0x00, 0x00, 0x00,
}
...
func (m *Post) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Response) > 0 {
		...
		i = encodeVarintPost(dAtA, i, uint64(len(m.Response)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Title) > 0 {
