...
const baseTimedoutPosts: object = { creator: '', id: 0, title: '', chain: '' }

export const TimedoutPosts = {
  encode(message: TimedoutPosts, writer: Writer = Writer.create()): Writer {
    if (message.creator !== '') {
  ...
  decode(input: Reader | Uint8Array, length?: number): TimedoutPosts {
    ...
    const message = { ...baseTimedoutPosts } as TimedoutPosts
