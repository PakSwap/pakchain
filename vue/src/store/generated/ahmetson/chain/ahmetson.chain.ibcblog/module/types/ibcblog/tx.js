...
const baseMsgCreateTimedoutPosts = { creator: '', title: '', chain: '' };
export const MsgCreateTimedoutPosts = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgCreateTimedoutPosts };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseMsgCreateTimedoutPostsResponse = { id: 0 };
export const MsgCreateTimedoutPostsResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgCreateTimedoutPostsResponse };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseMsgUpdateTimedoutPosts = { creator: '', id: 0, title: '', chain: '' };
export const MsgUpdateTimedoutPosts = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgUpdateTimedoutPosts };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseMsgUpdateTimedoutPostsResponse = {};
export const MsgUpdateTimedoutPostsResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgUpdateTimedoutPostsResponse };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                default:
...
const baseMsgDeleteTimedoutPosts = { creator: '', id: 0 };
export const MsgDeleteTimedoutPosts = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgDeleteTimedoutPosts };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseMsgDeleteTimedoutPostsResponse = {};
export const MsgDeleteTimedoutPostsResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgDeleteTimedoutPostsResponse };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                default:
...
const baseMsgCreateSentPost = { creator: '', postid: '', title: '', chain: '' };
...
export const MsgCreateSentPostResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgCreateSentPostResponse };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseMsgUpdateSentPost = { creator: '', id: 0, postid: '', title: '', chain: '' };
...
export const MsgUpdateSentPostResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgUpdateSentPostResponse };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                default:
...
export const MsgDeleteSentPostResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgDeleteSentPostResponse };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                default:
...
const baseMsgUpdatePost = { creator: '', id: 0, title: '', content: '' };
...
export class MsgClientImpl {
    ...
    SendIbcPost(request) {
        ...
        const promise = this.rpc.request('ahmetson.chain.ibcblog.Msg', 'SendIbcPost', data);
        return promise.then((data) => MsgSendIbcPostResponse.decode(new Reader(data)));
    }
    CreateTimedoutPosts(request) {
