...
import AhmetsonChainAhmetsonChainIbcblog from './ahmetson/chain/ahmetson.chain.ibcblog'
import AhmetsonChainAhmetsonChainBlog from './ahmetson/chain/ahmetson.chain.blog'
...
export default { 
  AhmetsonChainAhmetsonChainIbcblog: load(AhmetsonChainAhmetsonChainIbcblog, 'ahmetson.chain.ibcblog'),
  AhmetsonChainAhmetsonChainBlog: load(AhmetsonChainAhmetsonChainBlog, 'ahmetson.chain.blog'),
